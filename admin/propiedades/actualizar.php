<?php
    ...
    if($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $imagenPropiedad = mysqli_real_escape_string($db, $_POST['imagen']);
        ...
        if(empty($errores)) {
            ...
            if($resultado) {
                ...
                header('Location: /bienesraices/admin/propiedades?resultado=2');
            }
        }
    } 
...
?>
    ...
    <main class="contenedor seccion">
        ...
        <form class="formulario" method="POST" action="/bienesraices/admin/propiedades/actualizar.php" enctype="multipart/form-data">
            <fieldset>
